...
#    plt.plot([crash_offset + hole_avg,end_time], [perf_avg, perf_avg], "r-")
    ...
    print_statistics(holes_points, "hole")
    mesh_points_relatives = list(x - crash_offset for x in mesh_points)
    print_statistics(mesh_points_relatives, "next hop change")
